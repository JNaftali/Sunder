    ...
    if not snd.waiting.queue then
      ...
      elseif not snd.checksomeAffs({ "dementia", "paranoia", "hallucinations" }, 2) and snd.balance.madness then
        ...
        if snd.empowerready == true then -- if we can empower, do so to strip clarity
          string = "empower jhako" ..
              snd.sep .. "geo impress swirl" .. snd.sep .. "elicit madness " .. snd.target .. snd.sep .. biostring
        else
        ...
        string = string ..
            "incite " ..
            snd.shape_attacks[touse[1]] ..
            " " ..
            snd.target ..
            snd.sep ..
            biostring                             -- our shape from our priority list will be used
