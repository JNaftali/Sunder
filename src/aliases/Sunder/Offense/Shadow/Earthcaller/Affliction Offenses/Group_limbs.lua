if snd.class == "Earthcaller" then
  ...
  local chastenStack = { "anorexia", "recklessness", "justice", "stupidity", "self_loathing", "paranoia", "hypochondria",
    "lethargy" }
  local overwhelmChasten = { "recklessness", "anorexia", "justice", "stupidity", "self_loathing", "paranoia",
    "hypochondria", "lethargy" }
  ...
  function snd.attack_function()
    ...
    if not snd.waiting.queue then
      ...
      elseif snd.balance.smash and smashLimb then
        shield = "obliterate " .. smashLimb .. " " .. snd.target
      else
        local limb1, limb2
        ...
        shield = "shield crush " .. snd.target .. " " .. limb1 .. " and " .. limb2 .. snd.sep .. "osso splinter"
        battle = "none"
        chasten = "none"
      end
      if shield ~= "none" then
        if snd.toggles.affcalling and not snd.target_gone then
          if battle ~= "none" then
            string = string .. "wt Spur " .. snd.target .. ": " .. battle .. snd.sep
          end
        ...
        if chasten ~= "none" then
          string = string .. snd.sep .. "subdue " .. snd.target .. " " .. chasten
        end
      end
