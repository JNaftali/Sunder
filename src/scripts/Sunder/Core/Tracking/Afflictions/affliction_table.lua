snd.afflictions = {
  ...
  aff_mania                      = { state = "healed", effect = "", cures = { herb = "lobelia", tree = "send", focus = "send" }, assess = false, timer = createStopWatch() },
  aff_blackout                   = { state = "healed", effect = "", cures = {}, assess = false, timer = createStopWatch() },
  aff_blight                     = { state = "healed", effect = "", cures = { herb = "ash", tree = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_psychosis                  = { state = "healed", effect = "", cures = { herb = "ash", tree = "send" }, assess = false, timer = createStopWatch() },
  aff_sepsis                     = { state = "healed", effect = "", cures = { herb = "kelp", tree = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_egocentrism                = { state = "healed", effect = "can't help others", cures = { herb = "lobelia", tree = "send", focus = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_exhaustion                 = { state = "healed", effect = "dodge cut in half, slower movement", cures = { herb = "ginseng", tree = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_arrhythmia                 = { state = "healed", effect = "", cures = { herb = "bloodroot", tree = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_infestation                = { state = "healed", effect = "", cures = { herb = "goldenseal", tree = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_hypotension                = { state = "healed", effect = "", cures = { herb = "kelp", tree = "send" }, assess = false, timer = createStopWatch() },
  aff_loneliness                 = { state = "healed", effect = "", cures = { herb = "eucrasia", tree = "send", focus = "send" }, assess = false, timer = createStopWatch() },
  aff_infatuation                = { state = "healed", effect = "", cures = { herb = "bellwort", tree = "send", focus = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_delirium                   = { state = "healed", effect = "", cures = { herb = "ginseng", tree = "send", focus = "send" }, assess = false, timer = createStopWatch() },
  aff_mental_fatigue             = { state = "healed", effect = "", cures = {}, assess = false, timer = createStopWatch() },
  aff_mercy                      = { state = "healed", effect = "", cures = {}, assess = false, timer = createStopWatch() },
  ...
  aff_perplexity                 = { state = "healed", effect = "can't manipulate items", cures = { herb = "eucrasia", tree = "send" }, assess = false, timer = createStopWatch() },
  aff_petrified                  = { state = "healed", effect = "", cures = {}, assess = false, timer = createStopWatch() },
  aff_extravasation              = { state = "healed", effect = "", cures = { herb = "ginseng", tree = "send" }, assess = false, timer = createStopWatch() },
  ...
  aff_dyscrasia                  = { state = "healed", effect = "", cures = { herb = "ginseng", tree = "send" }, assess = false, timer = createStopWatch() },
