snd.defenses_list = {
  ...
  ["You are feeling extremely energetic."] = "instawake",
  ...
  ["Your resistance to damage by poison has been increased."] = "antivenin",
  ...
  ["You are fighting recklessly."] = "reckless",
  ...
  ["Your bones have been hardened greatly."] = "hardening",
  ["You have the cornering defence."] = "cornering",
  ["You are cornering your opponents."] = "cornering",
  ...
  ["You are shimmering with a ghostly light."] = "ghosted",
  ...
  ["You are concealed from the view of others."] = "concealed",
  ...
  ["You have masked your scent to others."] = "masked_scent",
  ...
  ["Gnashing your tongue, your mouth salivates with fluid."] = "salivating",
  ...
  ["Your flame tattoo is glowing faintly."] = "flame",
  ["You are surrounded by a nearly invisible magical shield."] = "shielded",
  ...
  ["You are claiming victory over your foes."] = "victory",
  ...
  ["You stand upon the guided road of destiny."] = "song_destiny",
  ...
  ["Your zealous fervour burns hot; you shall not break."] = "unbroken",
  ["You are refreshed and refocused."] = "warding_rigor",
  ["Your hound has created an opportunity for you to strike."] = "hound_opening",
  ["Your blood is strengthening the ties to your coffin."] = "deathlink",
  ["Your firefly tattoo glows softly."] = "firefly",
  ["Your wrath allows you to see through others."] = "wrath",
  ["Your spirit will surge with power should it falter."] = "resurgence",
  ["Your fists are wreathed in deep red flames."] = "firefist",
  ["The fog is obscuring your movements."] = "fog_obscure",
  ["Your simulacrum has exploited an opportunity for you to attack."] = "simulacrum_opening",
  ["You are filled with feral fury."] = "fury",
  ["Your movements are incredibly stealthy."] = "stealth",
  ["Your squire's resolve and resilience are bolstered."] = "spiritbolster",
  --Adherent
  ...
  ["You are radiating fiery incandescence."] = "seraph_radiate",
  ...
  ["You are diffused by a white mist."] = "mist_white",
  ["You are diffused by a red mist."] = "mist_red",
  ["You are diffused by a yellow mist."] = "mist_yellow",
  ["You are diffused by a blue mist."] = "mist_blue",
  ["You are diffused by a green mist."] = "mist_green",
