...
snd.areas = {
  ...
  { area = "Dun Fortress",                                level = "45-60",                  targets = { "an Orc guard", "an Orc soldier", "an Ogre sentry", "an Ogre knight", "an Ogre bowman", "an Orc archer", "an Orc sergeant", "an Orc captain", "an Ogre Captain", "a demonic screamer", "a serpentine blademistress", "a slime-encrusted spitter", "a dangerous water snake", "a large catfish" }, },
  ...
  { area = "The abandoned remnants of Xaanhal",           level = "really high",            targets = { "a firewrought behemoth", "an arcane anomaly", "a stoic bedrock colossus", "a churning tidal spectre", "an electrified sparkwraith", } },
  ...
  { area = "within a deep mine",                          level = "Mining",                 targets = { "a sallow-faced bandit", "a skeletal Hlugna warrior", "a bulbous direant bomber", "a sleek direant scout", "a chitinous direant soldier", "an agile direant worker", "a grimy bandit", "a bandit leader", "a dark-haired mole", "a stalagmite rat", "a writhing horsehair worm", "a massive, tunneling cave worm", "a many-eyed marionette slime", "a behemoth pit beast", "a floating cave manta", "a spotted cave salamander", "a fuzzy brown bat", "a rime-covered bear", "a long-jawed cave spider", "a thin, half-crazed mage", "a Hlungic spirit", "a bulbous, black spider", "a razor-finned eel", "a tiny blood worm", "a massive ice worm", "a pale, eyeless amphibian", "a chirping beetle", "a colony of bats", "a bristling, fanged bat", "a massive volcanic tortoise", "a luminous moth", "a lumbering volcanic golem" } },
  { area = "the Dyisen-Ashtan Memoryscape",               level = "99+",                    targets = { "an incorporeal townsman", "a spectral merchant", "an ethereal guardsman", "a spectral Balaton shark", "a fragmented, spectral memory", "a phantasmal mystic", "a disembodied soldier", "a ghostly seagull", "a ghastly beggar", "an eidolic, Seam-bound pilgrim", } },
  ...
  { area = "the Underbelly",                              level = "99+",                    targets = { "a desiccated Utari zombie", "a massive grey rat", "a dire, plagued rat", "a glazed-eye zombie Aslinn", "a snarling vakmut hound", "a slavering vakmut", "a grey-skinned skrell whelp", "a gigantic white rat", "a gigantic black rat", "a feral vakmut", "a malnourished vakmut", "a drooling zombie Tarpen", "a massive, tan-shelled whelk", "a jagged Golban ghast", "a hunched, bone-fisted Golban zombie", "a hulking Ursal ghast", "a crawling, ravenous Aslinn ghast", "an Utari cultist with grim facial markings", "a mangy Caentoi cultist", "an erratic Tarpen cultist", "a pale skrell whelp", "a venomous skrell whelp", "a ravenous skrell" } },
  { area = "the Mannaseh Swamp",                          level = "99+",                    targets = { "a skittering miscreation", "a savage mutant pumpkin", "a malformed stalker", "a miscreated avian", "an ichorous miscreation", "a hulking miscreation", "an amphibious malformation", } },
  ...
  { area = "Zenith's Vigil",                              level = "99+",                    targets = { "a four-winged ayvarin", "a swift vukon", "a predatory kashnalda", } },
  ...
  { area = "the Endless Battlefield",                     level = "90+",                    targets = { "a blood-drenched soldier wielding a claymore", "a blood-drenched swordsman", "a blood-drenched spear fighter", "a blood-drenched archer", } },
  ...
  { area = "a bandit encampment in the Bonro Sands",      level = "99",                     targets = { "a Caentoi bushwhacker", "a shifty Caentoi scoundrel", "a burly Caentoi raider", "a grizzled Caentoi highwayman", "a wiry Caentoi bandit", "a Caentoi marauder", "a sly Caentoi vagabond", "a grinning Caentoi cutthroat", "a thieving Caentoi outlaw", "a Caentoi blackguard", "Chief Kess, a Golban marauder", } },
  ...
  { area = "the Bonro Sands",                             level = "99+",                    targets = { "Match:a sun%-scorched %a+ haatun", "a Bonro spitting cobra", "a black-tailed viper", "a Bonro spitting cobra", "a scarlet kestrel", "a red-brown burrowing owl", "a lappet-faced vulture", "a horned viper", "an ostrich with wispy two-tone feathers", "a sun-spotted harrier", "an immense desert condor", "a crested haoroo", "a sun-scorched burnt umber haatun", "a crowned grouse" } },
  ...
  { area = "the shattered remnants of the Nazedha fleet", level = "LANU DU",                targets = { "a slimy Nazetu beastmaster", "a malignant Nazetu beastmaster", "a nauseating Nazetu slaver", "a gluttonous, writhing monstrosity", "a chaotic monstrosity of snapping maws", "a pestilent Nazedha monstrosity", "a sinister Chaos cultist", } },
  { area = "Qor Qogol",                                   level = "Dorfs n stuff",          targets = { "a felsic loamarl", "a clastic brechelf", "a striated reghorst" } },
  { area = "Snowswell",                                   level = "Easy but annoying",      targets = { "a snow wight" },                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   items = { "snow wight essence" } },
  { area = "a memory of Relovec Mansion",                 level = "Bring friends",          targets = { "an enraged memory of a female servant", "an enraged memory of a male servant", "an enraged memory of a female villager", "an enraged memory of a male villager" } },
}
