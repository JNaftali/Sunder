--- Default sunder bashing paths.
-- @module Bashing

--- Generate a custom bashing path based off of chosen areas.
-- @function snd_bashAreas
-- @param areas_chosen string comma separated list of areas
...
--- Default paths table.
-- @table snd.paths
-- @field high High-level bashing areas.
-- @field low Low-level bashing areas.
snd.paths = snd.paths or {}

--- High-level bashing areas.
snd.paths.high = {
  "Luzith's Lair",
  "Tiyen Esityi",
  "Dovan Hollow",
...
--- Beginning rooms for all areas.
-- @table snd.bashing_area_beginning_rooms
